        ...
        <div class="row">
            <div class="col-12 col-md-8 mx-auto">
                <div class="d-flex align-items-center gap-3 mb-2">
                    ...
                    <h1 class="fs-4 mb-0">Nuovo Negozio</h1>
                </div>
                    ...
                    <div class="card-body py-3">
                        <form action="{{ route('businesses.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-4 mb-2">
                                    ...
                                    <input type="text" name="name" id="business-name"
                                        ...
                                        placeholder="Es. Bottega del Sapone" value="{{ old('name') }}">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea name="story" id="business-story" rows="2" class="form-control @error('story') is-invalid @enderror">{{ old('story') }}</textarea>
                                    ...
                                    @foreach ($distinctiveTraits as $trait)
                                        <div class="form-check form-check-inline me-0">
                                            <input type="checkbox" name="distinctive_traits[]" value="{{ $trait->id }}"
                                                id="trait-{{ $trait->id }}" class="form-check-input">
                                            <label for="trait-{{ $trait->id }}"
                                                class="form-check-label">{{ $trait->name }}</label>
                                        </div>
                                    @endforeach
                                </div>
